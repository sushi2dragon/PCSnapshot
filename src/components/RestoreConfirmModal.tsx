      ...
      >
        ...
        >
          <span
            ...
            style={{
              backgroundColor: closeOthers ? "var(--color-accent, #4bbfc3)" : "transparent",
        ...
        >
          {unsaved && (
            <button
              ...
              style={{ backgroundColor: "rgba(75,191,195,0.15)", color: "var(--color-accent, #4bbfc3)" }}
            >
              Save current first
            </button>
          )}
          ...
          <button
            ...
            style={{ backgroundColor: "var(--color-accent, #4bbfc3)", color: "#11181a" }}
          >
            Restore
          </button>
        </div>
